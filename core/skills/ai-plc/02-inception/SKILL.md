...
| 📤 外部委譲 | 別の実行者（エンジニア・デザイナー・別チーム）がやるべき | **External Syncを促す** → Self-Describing構造で外部システムに書き出し |
...
---
## 参照元
- T002_コマンド体系再定義書 — Stage 2定義（本ページのベース）
- T003_コア原理再定義書 — Fractal Decomposition / Context Cascade原理
