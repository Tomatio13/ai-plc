...
echo "  3. ⚠️  Reload VS Code window (Cmd+Shift+P → 'Developer: Reload Window')"
echo "     to make /project: commands visible"
echo "  4. Run: /project:01-collection to start your first pipeline"
echo ""
